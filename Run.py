...
def main():
    blnKNNTrainingSuccessful = Plate_OCR.loadKNNDataAndTrainKNN()  # attempt KNN training
    ...
    for count in range(72, 73):
        try:
            ...
            imgOriginalScene = cv2.imread(f"Licenseplates/lpr{count}.jpeg")  # open image
            ...
            listOfPossiblePlates = LicensePlate.detectPlatesInScene(imgOriginalScene)  # detect plates

            listOfPossiblePlates = Plate_OCR.detectCharsInPlates(listOfPossiblePlates)  # detect chars in plates
            ...
            if len(listOfPossiblePlates) == 0:  # if no plates were found
                ...
                cv2.imwrite(f"Detectedplates/lpr{count}.jpeg", imgOriginalScene)  # write image out to file
